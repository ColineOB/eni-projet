...
public abstract class CodesResultatBLL {
	...
	/**
	 * Echec quand la date et heure de fin de la vente est inférieur à la date et
	 * heure de début de la vente
	 */
	 ...
	 * Echec quand la case du formulaire est nulle
	 */
	public static final int REGLE_ARTICLE_CATEGORIE_1_ERREUR = 20003;
